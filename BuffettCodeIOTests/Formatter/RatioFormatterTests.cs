...
namespace BuffettCodeIO.Formatter.Tests
{
    ...
    public class RatioFormatterTests
    {
        ...
        public void TestFormat()
        {
            ...
            var dividend_yield_forecast = new PropertyDescription("dividend_yield_forecast", "配当利回り（会社予想）", "%");
            var dividend_yield_actual = new PropertyDescription("dividend_yield_forecast", "配当利回り（実績）", "%");
            var others = new PropertyDescription("any", "any", "%");
            string formatted;
