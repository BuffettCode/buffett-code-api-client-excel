...
namespace BuffettCodeAPIClient.Tests
{
    ...
    public class BuffettCodeApiV2ClientTests
    {
        ...
        public void GetTest()
        {
            ...
            Assert.IsNotNull(client.Get(DataTypeConfig.Indicator, ticker, Snapshot.GetInstance(), false, true, false));
            ...
            Assert.ThrowsException<NotSupportedDataTypeException>(() => client.Get(DataTypeConfig.Daily, ticker, day, false, true, false));
        }
